...
import { colors } from './calender.component';
...
export class CalenderComponent implements OnInit, OnChanges {
    ...
    if (this.events.length > this.data.length) {
        this.events = this.data;
        this.activeDayIsOpen = false;
    } else { */
        /*            if (formatCustomTime(date) !== 'Sat' && formatCustomTime(date) !== 'Sun') {
            this.events = [
                ...this.events,
                {
                    id: 0,
                    ...
                    actions: [
                        {
                            ...
                            onClick: ({ event }: { event: CalendarEvent }): void => {
                                this.sendDayClickedEvent.emit({ date, events });
                            },
                            cssClass: 'text-info',
                        },
                    ],
